...
public class RatingDaoTest {
    ...
    public RatingDaoTest() {
        ratingDao = new RatingDao("animetest");
    }
    ...
    /**
     * Test of getNumberOfRatingIdsForAnime method, of class RatingDao.
     */
    @Test
    public void testGetNumberOfRatingIdsForAnime() {
        System.out.println("getNumberOfRatingIdsForAnime");
        RatingDao instance = null;
        int expResult = 15;
        int result = ratingDao.getNumberOfRatingIds();
        assertEquals(expResult, result);
