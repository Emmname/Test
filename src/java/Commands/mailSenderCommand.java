    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (name != null && !name.equals("")
            ...
            if (user != null && !user.equals("")) {
                try {
                    //send email with the resetpassword link to the user
...
//                    Logger.getLogger(mailSenderCommand.class.getName()).log(Level.SEVERE, null, ex);
                    String failedMessage = "Sorry The mail message required a valid address. "+ ex.getMessage();
                    HttpSession session = request.getSession();
            ...
            String errorMessage = "Sorry, your email has not been sent. "
